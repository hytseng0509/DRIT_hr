...
class TrainOptions():
  def __init__(self):
    ...
    self.parser.add_argument('--resize_size', type=int, default=360, help='resized image size for training')
    self.parser.add_argument('--crop_size', type=int, default=340, help='cropped image size for training')
    ...
    self.parser.add_argument('--ms', action='store_true', help='apply mode seeking loss')
    ...
    self.parser.add_argument('--n_ep', type=int, default=90, help='number of epochs')
